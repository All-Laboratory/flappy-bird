...
- 💧 **White Liquid Trail Physics**: Glossy milky white fluid droplets trailing dynamically behind the bird + splash bursts.
- 🎧 **Audio System**: Supports .mp4, .m4a, .mp3, .wav, .aac, and Web Audio procedural synthesis.
  - Default Flap: lap.mp4
  - Default Crash: crashpoint.mp4
...
## ⌨️ Controls
- **Flap / Jump**: Space / Up Arrow / W / Click / Tap
- **Pause**: P
- **Fullscreen**: F
- **Mute**: M
- **Settings**: ⚙️ Settings
